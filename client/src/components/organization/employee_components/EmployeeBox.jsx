...
const EmployeeBox = (props) => {
  ...
  return(
    ...
    : <>
        ...
        <svg style={{width:"2.5em", height:"2.5em", margin:"1em"}} viewBox="0 0 24 24" onClick={verifyEmployee}>
        ...
        <svg style={{width:"2.5em", height:"2.5em", margin:"1em"}} viewBox="0 0 24 24" xlinkHref={`/organization/user_page#${id}`}>
